...
public class CategoriaResource {
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<Categoria> pageReturn = service.findPage(Integer.parseInt(page), Integer.parseInt(linesPerPage), orderBy, direction);
		Page<CategoriaDTO> listDto = pageReturn.map(obj -> new CategoriaDTO(obj));
		return ResponseEntity.ok().body(listDto);
	}
